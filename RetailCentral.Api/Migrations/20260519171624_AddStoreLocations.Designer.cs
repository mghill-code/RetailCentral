...
namespace RetailCentral.Api.Migrations
{
    ...
    [Migration("20260519171624_AddStoreLocations")]
    partial class AddStoreLocations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrchestrationTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("OrchestrationTemplates", (string)null);
                });

            modelBuilder.Entity("OrchestrationTemplateStep", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("OnFailureAction")
                        .HasColumnType("int");

                    b.Property<string>("ParametersJson")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("RollbackTemplateStepId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("OrchestrationTemplateSteps", (string)null);
                });

            modelBuilder.Entity("ProvisioningProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("StoreGroup");

                    b.HasIndex("TemplateId");

                    b.ToTable("ProvisioningProfiles", (string)null);
                });
            ...
            modelBuilder.Entity("RetailCentral.Api.Data.Entities.Orchestration.EnrollmentAction", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<int?>("AssignedProfileId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("InitialRunId");

                    b.HasIndex("Status");

                    b.ToTable("EnrollmentActions", (string)null);
                });

            modelBuilder.Entity("RetailCentral.Api.Data.Entities.Orchestration.OrchestrationRun", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("OrchestrationRuns", (string)null);
                });

            modelBuilder.Entity("RetailCentral.Api.Data.Entities.Orchestration.OrchestrationRunStep", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("OrchestrationRunSteps", (string)null);
                });
            ...
            modelBuilder.Entity("RetailCentral.Api.Models.StoreLocation", b =>
                {
            ...
            modelBuilder.Entity("OrchestrationTemplateStep", b =>
                {
                    b.HasOne("OrchestrationTemplate", "Template")
                        .WithMany("Steps")
            ...
            modelBuilder.Entity("RetailCentral.Api.Data.Entities.Orchestration.EnrollmentAction", b =>
                {
                    b.HasOne("ProvisioningProfile", "AssignedProfile")
                        .WithMany()
                        .HasForeignKey("AssignedProfileId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("RetailCentral.Api.Data.Entities.Orchestration.OrchestrationRun", "InitialRun")
                        .WithMany()
                        .HasForeignKey("InitialRunId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("AssignedProfile");

                    b.Navigation("InitialRun");
                });
            ...
            modelBuilder.Entity("RetailCentral.Api.Data.Entities.Orchestration.OrchestrationRunStep", b =>
                {
                    b.HasOne("RetailCentral.Api.Data.Entities.Orchestration.OrchestrationRun", "Run")
                        .WithMany("Steps")
                        .HasForeignKey("RunId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OrchestrationTemplateStep", "TemplateStep")
                        .WithMany()
            ...
            modelBuilder.Entity("OrchestrationTemplate", b =>
                {
                    b.Navigation("ProvisioningProfiles");
